    ...
    return (
        <div className="side-panel" style={{ width: '350px' }}> 
            ...
            {userDetails.type !== 'Standard' && (
                ...
                {!event.temp && (
                    <button className="card-delete" onClick={handleDeleteInitiate} style={{ visibility: isEditMode ? 'visible' : 'hidden' }}>
                    Delete
                    </button>
                )}
                </>
            ...
            <button
                ...
                onClick={event.temp ? handleCancelCreation : onClose} 
            >
                {event.temp ? "Cancel" : "Close"}
            </button>
            </div>
